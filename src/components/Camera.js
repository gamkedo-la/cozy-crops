...
export default class Camera {
  constructor (config) {
    ...
    this.x = Math.floor(this.player1.x - this.imageManager.internalCanvas.width / (2 * ImageScale))
    this.y = Math.floor(this.player1.y - this.imageManager.internalCanvas.height / (2 * ImageScale))
  }
