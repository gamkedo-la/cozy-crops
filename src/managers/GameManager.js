  ...
  manager.state = {
    ...
    Map: {
      Achievements: [
        ...
        { name: 'Master Gatherer', incompleteDescription: 'Forage for 50 items from the world to earn this Plaque', completeDescription: 'Congratulations! You found 50 items', type: EntityTypes.PlaqueForaging, requiredCount: 50, currentCount: 0, complete: false },
